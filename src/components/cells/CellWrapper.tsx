...
export default function CellWrapper({
  ...
  const extensions = useMemo(
    () => [
      ...
      RemoveOutline, // این می‌تونه ثابت تعریف بشه بیرون از کامپوننت
    ...
    [] // چون تنظیمات استاتیک هستند، وابستگی نداره
  );
  ...
  return (
    <div className="relative mx-auto max-w-200 mb-4 transition-all group shadow-primary dark:shadow-sm dark:shadow-black/10 bg-cell-light dark:bg-cell-dark rounded-lg duration-200 overflow-hidden">
